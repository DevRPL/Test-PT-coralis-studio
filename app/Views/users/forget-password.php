...
<div class="min-h-screen flex items-center">
  <main id="content" role="main" class="justify-center w-full max-w-md mx-auto p-6">
      ...
      <div class="p-4 sm:p-7">
        <div class="text-center">
          ...
          <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <a class="text-blue-600 decoration-2 hover:underline font-medium" href="<?= base_url('login'); ?>">
              Login here
            </a>
          </p>
        </div>
